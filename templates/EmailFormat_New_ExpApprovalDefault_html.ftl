...
<#macro divData style='text-align:left; font-weight:bold; margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; padding: 3px 0; line-height: 18px' value="${BLANK}">
...
<#macro columnData tdstyle="" divstyle="" valign="top" data="${HTML_SPACE}" width="${BLANK}" colspan="1">
	...
	<#else>
		<td valign="${valign}" style="${tdstyle}" colspan="${colspan}">
			<@divData style="${divstyle}" value="${data}" />
		</td>
	</#if>
</#macro>
				...
				<table cellpadding='0' cellspacing='0' width='100%' style='background:#31B4CB; color:#FFFFFF; font-size:12pt; border-radius: 5px 5px 0 0;'>
					<tr>
						<td style='border-bottom: 1pt solid #B4C1C6; padding: 14px 15px 14px 28px;' valign='top'>
							<@divData style="text-align:left; font-weight:bold; margin-left:5px; margin-right:5px; font-family:'Titillium Web',helvetica,tahoma,arial,sans-serif; padding: 3px 0; line-height: 18px;" value="${replaceWithConstant(value[0])}" />
						</td>
						<td style='border-bottom: 1pt solid #B4C1C6; padding: 14px 15px 14px 28px;' valign='top'>
							<@divData style="text-align:right; font-weight:normal; margin-left:5px; margin-right:5px; font-family:'Hind',helvetica,tahoma,arial,sans-serif; padding: 3px 0; line-height: 18px;" value="${value[1]}" />
						</td>
					</tr>
				</table>
			</td>
                            ...
                            <tr>
                                <td valign="top" colspan="2">
                                    <div style="font-family:tahoma,arial,sans-serif; max-width:596px; margin-left:5px; margin-right:5px;">
                                        <br/>
                                        <@spanData value=effectiveText />
                                        <a href="${effectiveUrl}" style="text-decoration:underline; font-family:tahoma,arial,sans-serif; color: #58C4D7;">
                                            <@spanData value= getMessageProperty("expense.email.text.click_here") />
                                        </a>
										<@spanData value="." />
									</div>
...
<#macro writeInstructionCustomizeDeepLinkText value Instructions_URL InstructionsViewReportText_URL IsWatcherNotification = false>
	<#if IsWatcherNotification>
		<#local watcherInstructionKey = "expense.email.text.watcherInstructions">
		<#local watcherInstructionValue = getMessageProperty(watcherInstructionKey)>
		<#if !watcherInstructionValue?contains(watcherInstructionKey)>
	...
	<#if value?? && (value?length>0)>
		<tr>
			<td colspan="2">
				<table cellpadding="0" cellspacing="0" width="100%" align="center" style="text-align:left; color:${topinfo?string('#404040','#9FA4A6')}; padding: 10px 15px 10px 28px; background:${topinfo?string('#FFFFFF;','#475156;')}">
					<#if topinfo>
						<@writeBottompage />
					</#if>
					<#assign splitValue = value?replace("<BR>","<br>")?split("<br>")>
...
<#function hideDefaulInstructions>
	<#local inst1 = replaceWithConstant('instructions1')>
	<#local inst2 = replaceWithConstant('instructions2')>
	<#local inst3 = replaceWithConstant('instructions3')>
	<#local inst4 = replaceWithConstant('instructions4')>
	<#local inst5 = replaceWithConstant('instructions5')>
	<#if (inst1?length=0) && (inst2?length=0) && (inst3?length=0) && (inst4?length=0) && (inst5?length=0)>
		<#return true>
	<#else>
		<#return false>
	</#if>
...
<#macro writeDefaultinstructionCustomizeDeepLinkText args Instructions_URL InstructionsViewReportText_URL>
	<#if !hideDefaulInstructions()>
			...
			<tr>
				<td colspan="2" align="center">
					<table cellpadding="0" cellspacing="0" width="100%" style="text-align:left; font-size:13px; max-width: 452px; margin: 20px 0px;color:${topinfo?string('#404040','#9FA4A6')}">
						...
						<tr>
							<td valign="top">
								<div style="font-family:tahoma,arial,sans-serif; max-width:24px; margin-left:5px; margin-right:5px;">
...
<#macro writeDefaultinstruction args Instructions_URL InstructionsViewReportText_URL>
	...
	<#-- Info row which contains emails -->
		<tr>
			<td colspan="2" align="center">
				<table cellpadding="0" cellspacing="0" width="92%" style="text-align:left; font-size:13px; max-width: 452px; margin: 20px 4%;color:${topinfo?string('#404040','#9FA4A6')}">
					<#if topinfo>
						<@writeBottompage />
					</#if>
					<tr>
...
<#macro writeExpenseRow expenserowdata>
	<#if (expenserowdata?has_content)>
		...
		<tr>
	    	<td align="center">
	            <table cellpadding="0" cellspacing="0" align="center" width="92%" style="line-height: 18px; font-size:9pt; font-weight:normal; color:#404040; background:#FFFFFF; margin: 0 4%;">
	            		...
	            		<#if (expenserow??) && (expenserow?size > 1)>
							...
							<tr>
								<td class="tdcol" valign="top" width="${precentToPixelConverter(width_td)}">
									<@divData style="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; min-width:135px; padding: 3px 0; line-height: 18px; max-width:${precentToPixelConverter(width_td)}px;" value="${nbsp?string(HTML_SPACE,replaceWithConstant(expenserow[0]))}" />
								</td>
								<td style="font-weight: bold;" valign="top" width="${precentToPixelConverter(100-width_td)}">
									<@divData style="text-align:left; margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif;  padding: 3px 0; line-height: 18px; max-width:${precentToPixelConverter(100-width_td)}px;"
...
<#macro writeCompliancewarning compliancewarning>
	<#if (compliancewarning??) && (compliancewarning?size > 0)>
		...
		<tr>
			<td align="center">
				<table cellpadding="0" cellspacing="0" width="92%" style="font-size:9pt; color:#404040; text-align:left; margin: 0 4%;">
...
<#macro writeNotes listdata>
	<#if (listdata??) && (listdata?size > 0)>
		...
		<tr>
			<td align="center">
				<table cellpadding="0" cellspacing="0" width="92%" style="font-size:14px; color:#404040; text-align:left; background:#FFFFFF; line-height: 24px; margin: 0 4%;">
					<tbody>
            			<tr>
...
<#macro writeExpensepurpose name listdata>
	<#if listdata?has_content>
		<tr>
			<td align="center">
				<table cellpadding="0" cellspacing="0" width="92%" style="line-height: 24px; text-align:left; font-size:9pt; color:#404040; background:#FFFFFF; margin: 0 4%;">
...
<#macro writeExpenseaccountsummary name listdata>
	<#if listdata?has_content>
		<tr>
			<td align="center">
				<table cellpadding="0" cellspacing="0" width="92%" style="line-height: 24px; margin: 0 4%; text-align:left; font-size:13px; color:#404040; background:#FFFFFF;">
					<tr>
						<#list listdata as row>
							<#if row??>
								<#if (row?size>4)>
							...
							<#if row?size=1>
								<tr>
									<td colspan="${columns}" style="${styles_for_border}">
										<@divData style="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; max-width:596px; padding: 3px 0; line-height: 18px;" value="${row[0]}" />
									</td>
								</tr>
							<#elseif row?size=4>
								<tr>
									<@columnData tdstyle="${styles_for_border}"
										divstyle="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; min-width:105px; padding: 3px 0; line-height: 18px;" data="${row[0]}"/>
									<#if row[2]?has_content>
										<@columnData tdstyle="${styles_for_border}"
											divstyle="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; padding: 3px 0; line-height: 18px;" data="${row[1]}"/>
										<@columnData tdstyle="${styles_for_border}"
											divstyle="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; padding: 3px 0; line-height: 18px;" data="${row[2]}"/>
									<#else>
										<@columnData colspan='2' tdstyle="${styles_for_border}"
											divstyle="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; padding: 3px 0; line-height: 18px;" data="${row[1]}"/>
									</#if>
									<@columnData tdstyle="${styles_for_border}"
										divstyle="text-align:right; margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; min-width:90px; padding: 3px 0; line-height: 18px;" data="${row[3]}"/>
								</tr>
							<#elseif row?size=5>
								<tr>
									<@columnData tdstyle="${styles_for_border}"
									...
									<@columnData tdstyle="${styles_for_border}"
										divstyle="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; padding: 3px 0; line-height: 18px;" data="${row[2]}"/>
									<@columnData tdstyle="${styles_for_border}"
										divstyle="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; padding: 3px 0; line-height: 18px;" data="${row[3]}"/>
									<@columnData tdstyle="${styles_for_border}"
										divstyle="text-align:right; margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; min-width:90px; padding: 3px 0; line-height: 18px;" data="${row[4]}"/>
								</tr>
							</#if>
						</#if>
					</#list>
...
<#macro writeSummaries name listdata>
	<#if listdata?has_content>
		...
		<tr>
			<td align="center">
				<table cellpadding="0" cellspacing="0" width="92%" style="line-height: 24px; margin: 0 4%; font-size:13px; color:#404040; background:#FFFFFF;">
					<tr>
...
<#macro writeUdadatadetail listdata>
	<#if listdata?has_content>
		<tr>
			<td align="center">
				<table cellpadding="0" cellspacing="0" width="92%" style="font-size:14px; line-height: 24px; margin: 0 4%; color:#404040; text-align:left; background:#FFFFFF;">
					<tr>
...
<#macro writeExpensedetails_ expensedetails_ listdataComplianceWarnings listdataNotes listdataReceipts>
	...
	<#if (expensedetails_?has_content)>
		...
		<tr>
			<td align="center">
				<table data-key="expensedetailsItems" cellpadding="0" cellspacing="0" width="92%" style="text-align:left; margin: 0 4%; line-height: 24px; font-size:13px; color:#404040; background:#FFFFFF;">
					<tbody>
            			<tr data-array="start">
            				<td colspan="4">
            				...
            				<#list expensedetails_ as block>
            					...
            					<#if block?? && (block?size>0)>
									<#if block?first?first?lower_case?matches('child')>
										<tr>
											<td colspan="5" style="padding-left: 6px; border-left: 8px solid #eaeaea;">
												<table cellpadding="0" cellspacing="0" width="100%" style="text-align:left; margin: 0; line-height: 24px; font-size:13px; color:#404040; background:#FFFFFF;">
									</#if>
            						<#list block as args>
            							<#if (args?size=0)>
            								<#if (k>0) || (l>0) || (p>0) || (j>0) || (n>0) || (m>0) >
	        	    							<tr>
	            									<td style="border-top: 1px solid #E7E9EA;" colspan="4">
	            										<div> ${HTML_SPACE} </div>
	            									</td>
	            								</tr>
        									...
        									<#if args[0]?lower_case?matches('child')>
												...
												<#switch args?size>
													<#case 2> <#-- actually case 1 -->
														<tr data-array>
															<td data-string style="${(k=0 && p=0 && n=0)?string('border-top: 1px solid #E7E9EA;', '')}" valign="top" colspan="4">
																<@divData style="padding-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; max-width:596px;" value="${args[1]!BLANK}" />
															</td>
														</tr>
														<#local k=k+1>
													<#break>
													<#case 3> <#-- actually case 2 -->
														<tr data-array>
															<td data-string class="tdcolumn" style="${(l=0)?string('border-top: 1px solid #E7E9EA;', '')} border-bottom: 1px solid #E7E9EA; line-height: 24px;" valign="top" colspan="1" width="${precentToPixelConverter(25)}">
																<@divData style="padding-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; display: inline-block; padding-right: 5px" value="${replaceWithConstant(args[1]!BLANK )}" />
															</td>
															<td data-string style="${(l=0)?string('border-top: 1px solid #E7E9EA;', '')} border-bottom: 1px solid #E7E9EA; text-align: right; line-height: 24px;" valign="top" colspan="3" width="${precentToPixelConverter(75)}">
																<@divData style="line-height: 18px; display: inline-block; font-family:tahoma,arial,sans-serif; padding: 0 5px" value="${replaceWithConstantForUDA(args[2]!BLANK )}" />
															</td>
														</tr>
														<#local l=l+1>
													<#break>
													<#case 4> <#-- actually case 3 -->
														<tr data-array>
															<td data-string style="${(p=0 && n=0)?string('border-top: 1px solid #E7E9EA;', '')} margin-left:5px; background: #eaeaea;" valign="top" colspan="1">
																<@divData style="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; max-width:119px;" value="${args[1]!BLANK}" />
															</td>
															<#if args[2]?replace(" ", "")?has_content>
																<td data-string style="${(p=0 && n=0)?string('border-top: 1px solid #E7E9EA;', '')} background: #eaeaea;" valign="top" colspan="1">
																	<@divData style="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; max-width:179px;" value="${args[2]!BLANK}" />
																</td>
																<td data-string style="${(p=0 && n=0)?string('border-top: 1px solid #E7E9EA;', '')} background: #eaeaea;" valign="top" colspan="2">
																	<@divData style="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; max-width:298px;" value="${args[3]!BLANK}" />
																</td>
															<#else>
																<td data-string style="${(p=0 && n=0)?string('border-top: 1px solid #E7E9EA;', '')} background: #eaeaea;" valign="top" colspan="2">
																	<@divData style="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; max-width:179px;" value="${args[2]!BLANK}" />
													...
													<#case 5> <#-- actually case 4 -->
														<tr data-array>
															<td data-string style="${(n=0)?string('border-top: 1px solid #E7E9EA;', '')} background: #eaeaea;" valign="top">
																<@divData style="padding-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; max-width:119px;" value="${args[1]!BLANK}" />
															</td>
															<td data-string style="${(n=0)?string('border-top: 1px solid #E7E9EA;', '')} background: #eaeaea;" valign="top">
																<@divData style="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; max-width:179px;" value="${replaceWithConstantForItemType(args[2]!BLANK)}" />
															</td>
															<td data-string style="${(n=0)?string('border-top: 1px solid #E7E9EA;', '')} background: #eaeaea;" valign="top">
																<@divData style="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; max-width:179px;" value="${args[3]!BLANK}" />
															</td>
															<td data-string style="${(n=0)?string('border-top: 1px solid #E7E9EA;', '')} background: #eaeaea;" valign="top">
																<@divData style="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; text-align:right; min-width:90px; max-width:119px;" value="${args[4]!BLANK}" />
															</td>
														</tr>
														<#local n=n+1>
													<#break>
													<#case 6> <#-- actually case 5 -->
														<tr data-array>
															<td colspan="5">
																<table cellpadding="0" cellspacing="0" width="100%" style="text-align:left; font-size:12px; color:#404040; background:#FFFFFF;">
																	<#if j=0>
																		<tr>
																			<@columnData tdstyle="border-bottom: 1px solid #E7E9EA;"
																				divstyle="text-align:left; margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif;" data="${replaceWithConstant('Name')}"/>
																			<@columnData tdstyle="border-bottom: 1px solid #E7E9EA;"
																				divstyle="text-align:left; margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif;" data="${replaceWithConstant('Company')}"/>
																			<@columnData tdstyle="border-bottom: 1px solid #E7E9EA;"
																	...
																	<tr>
																		<@columnData tdstyle="border-bottom: 1px solid #E7E9EA;" width="${precentToPixelConverter(25)}"
																			divstyle="line-height: 18px; margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; max-width:${precentToPixelConverter(25)}px;" data="${args[1]}"/>
																		<@columnData tdstyle="border-bottom: 1px solid #E7E9EA;" width="${precentToPixelConverter(25)}"
																			divstyle="line-height: 18px; margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; max-width:${precentToPixelConverter(25)}px;" data="${args[2]!BLANK}"/>
																		<@columnData tdstyle="border-bottom: 1px solid #E7E9EA;" width="${precentToPixelConverter(10)}"
																			divstyle="line-height: 18px; margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; text-align:right; max-width:${precentToPixelConverter(10)}px;" data="${args[3]!BLANK}"/>
																		<@columnData tdstyle="border-bottom: 1px solid #E7E9EA;" width="${precentToPixelConverter(20)}"
																			divstyle="line-height: 18px; margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; text-align:right; max-width:${precentToPixelConverter(20)}px;" data="${args[4]!BLANK}"/>
																		<@columnData tdstyle="border-bottom: 1px solid #E7E9EA;" width="${precentToPixelConverter(20)}"
																			divstyle="line-height: 18px; margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif max-width:${precentToPixelConverter(20)}px;; text-align:right;" data="${args[5]!BLANK}"/>
																	</tr>
																</table>
															</td>
														</tr>
    										...
    										<#else>
												...
												<#switch args?size>
        											<#case 1>
        												<tr data-array>
        													<td data-string style="${(k=0 && p=0 && n=0)?string('border-top: 1px solid #E7E9EA;', '')}" valign="top" colspan="4">
        														<@divData style="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif;" value="${args[0]}" />
        													</td>
        												</tr>
        												<#local k=k+1>
        											<#break>
        											<#case 2>
        												<tr data-array>
        													...
        													<td style="${(l=0)?string('border-top: 1px solid #E7E9EA;', '')} border-bottom: 1px solid #E7E9EA; text-align: right; line-height: 24px;" valign="top" colspan="3" width="${precentToPixelConverter(75)}">
        														<@divData style="line-height: 18px; padding: 0 5px; font-family:tahoma,arial,sans-serif;" value="${replaceWithConstantForUDA(args[1]!BLANK )}" />
        													</td>
        												</tr>
        												<#local l=l+1>
        											<#break>
        											<#case 3>
        												<tr>
        													<td style="${(p=0 && n=0)?string('border-top: 1px solid #E7E9EA;', '')} background: #eee;" valign="top" colspan="1">
        														<@divData style="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif;" value="${args[0]}" />
        													</td>
															<#if args[2]?replace(" ", "")?has_content>
																<td style="${(p=0 && n=0)?string('border-top: 1px solid #E7E9EA;', '')} background: #eee;" valign="top" colspan="1">
																	<@divData style="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif;" value="${args[1]!BLANK}" />
																</td>
																<td style="${(p=0 && n=0)?string('border-top: 1px solid #E7E9EA;', '')} background: #eee;" valign="top" colspan="2">
																	<@divData style="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif;" value="${args[2]!BLANK}" />
																</td>
															<#else>
																<td style="${(p=0 && n=0)?string('border-top: 1px solid #E7E9EA;', '')} background: #eee;" valign="top" colspan="2">
																	<@divData style="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif;" value="${args[1]!BLANK}" />
        											...
        											<#case 4>
        												<tr>
        													<td style="${(n=0)?string('border-top: 1px solid #E7E9EA;', '')} background: #eee;" valign="top">
        														<@divData style="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif;" value="${args[0]}" />
        													</td>
        													<td style="${(n=0)?string('border-top: 1px solid #E7E9EA;', '')} background: #eee;" valign="top">
        														<@divData style="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif;" value="${replaceWithConstantForItemType(args[1]!BLANK)}" />
        													</td>
        													<td style="${(n=0)?string('border-top: 1px solid #E7E9EA;', '')} background: #eee;" valign="top">
        														<@divData style="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif;" value="${args[2]!BLANK}" />
        													</td>
        													<td style="${(n=0)?string('border-top: 1px solid #E7E9EA;', '')} background: #eee;" valign="top">
        														<@divData style="margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; text-align:right; min-width:90px;" value="${args[3]!BLANK}" />
        													</td>
        												</tr>
        												<#local n=n+1>
        											<#break>
        												...
        												<tr>
        													<td colspan="4">
        														<table cellpadding="0" cellspacing="0" width="100%" style="text-align:left; font-size:12px; color:#404040; background:#FFFFFF;">
        															...
        															<tr>
																		<@columnData tdstyle="border-bottom: 1px solid #E7E9EA;" width="${precentToPixelConverter(25)}"
																			divstyle="line-height: 18px; margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; max-width:${precentToPixelConverter(25)}px;" data="${args[0]}"/>
																		<@columnData tdstyle="border-bottom: 1px solid #E7E9EA;" width="${precentToPixelConverter(25)}"
																			divstyle="line-height: 18px; margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; max-width:${precentToPixelConverter(25)}px;" data="${args[1]!BLANK}"/>
																		<@columnData tdstyle="border-bottom: 1px solid #E7E9EA;" width="${precentToPixelConverter(10)}"
																			divstyle="line-height: 18px; margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; text-align:right; max-width:${precentToPixelConverter(10)}px;" data="${args[2]!BLANK}"/>
																		<@columnData tdstyle="border-bottom: 1px solid #E7E9EA;" width="${precentToPixelConverter(20)}"
																			divstyle="line-height: 18px; margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; text-align:right; max-width:${precentToPixelConverter(20)}px;" data="${args[3]!BLANK}"/>
																		<@columnData tdstyle="border-bottom: 1px solid #E7E9EA;" width="${precentToPixelConverter(20)}"
																			divstyle="line-height: 18px; margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; text-align:right; max-width:${precentToPixelConverter(20)}px;" data="${args[4]!BLANK}"/>
    																</tr>
        														</table>
                                                      ...
                                                      <tr>
                                                          <td colspan="4">
                                                              <table cellpadding="0" cellspacing="0" width="100%" style="text-align:left; font-size:12px; color:#404040; background:#FFFFFF;">
                                                                  <#if m=0>
                                                                      <tr>
                                                                          <td style='border-bottom: 1px solid #E7E9EA;' width='${precentToPixelConverter(width_td)}' colspan='10'>
            		            	...
            		            	<#if (listdataReceipts?size>index)>
	    								...
	    								<#if link?has_content>
		    								<tr>
	        									<td class="tdcolumn" style="border-bottom: 1px solid #E7E9EA;" valign="top" colspan="1" width="${precentToPixelConverter(20)}">
	        										<@divData style="line-height: 24px; margin-left:5px; margin-right:5px; font-family:tahoma,arial,sans-serif; max-width:119px;" value="${replaceWithConstant('receipts')}" />
	        									</td>
	        									<td valign="top" colspan="3" width="${precentToPixelConverter(80)}" style="text-align: right; border-bottom: 1px solid #E7E9EA;">
	        										<a href="${link}" style="color:#404040;  text-decoration:none; font-family:tahoma,arial,sans-serif;">
														<@spanData style="line-height: 24px; margin-left:5px; margin-right:5px; color:#0089B7; text-decoration:underline; font-family:tahoma,arial,sans-serif;  -webkit-text-size-adjust:none;" value="${replaceWithConstant('view')}" />
													</a>
	        									</td>
	        								</tr>
	        							</#if>
    								...
    								<#if itemNotes?has_content>
    									...
    									<#list itemNotes as itemNote>
    										<#if itemNote?has_content && (itemNote?size>1)>
    											<tr>
    												<td style="${(ind=0)?string('border-top: 1pt solid #E7E9EA;','')}" valign="top" colspan="1" width="${precentToPixelConverter(25)}">
...
<#macro writeAttorneyBudgetSummaries name listdata>
	<#if listdata?has_content>
		...
		<tr>
			<td align="center">
				<table cellpadding="0" cellspacing="0" width="92%" style="margin: 0 4%; line-height: 24px;font-size:9pt; color:#404040; background:#FFFFFF;">
					<tr>
...
<#macro writePreapprovalsummary listdata>
	<#if listdata?has_content>
		...
		<tr>
			<td align="center">
				<table cellpadding="0" cellspacing="0" width="92%" style="line-height: 24px; font-size:14px; color:#404040; text-align:right; background:#FFFFFF; margin: 0 4%;">
					<tr>
						<@columnData width="${precentToPixelConverter(60)}"
					...
					<#list listdata as row>
						...
						<#if row?? && (row?size>1)>
							<#if row[0]?matches('Adjustments')>
								<tr>
									<@columnData tdstyle="line-height: 24px; max-width:149px;${styles_for_border};" width="${precentToPixelConverter(60)}"
